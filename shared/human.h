...
// void Human_EnablePoseControl( Human* human, b3Fixed springHertz, bool enablePoseControl );
// void Human_AdjustPoseControl( Human* human, b3Fixed springHertz );
// void Human_DriveBase( Human* human, b3Transform transform, b3Fixed timeStep );
