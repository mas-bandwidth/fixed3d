...
Status: **DRAFT for review** (Rowan, 2026-07-15). Task #9 phase 1 — design
only, no code. Built on the four-lens precision-architecture survey
(preserved in the private rowan repo, `investigations/precision-architecture/`).
