...
// Fixed3D compile-time options.
//
// Normally set by the CMake BOX3D_* options. If you build Fixed3D without its
...
// and point Fixed3D at them from your build:
//
...
// Decorate the public API with your own export macro instead of Fixed3D's
// box3d_EXPORTS/BOX3D_DLL scheme, for example when compiling Fixed3D into another
