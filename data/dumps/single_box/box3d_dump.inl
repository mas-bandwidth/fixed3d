b3Vec3 gravity = {0, B3_FIX( -10.0 ), 0};
...
}
{
  ...
  bd.position = {0, B3_FIX( -1.0 ), 0};
  bd.rotation = {{0, 0, 0}, B3_FIX( 1.0 )};
...

  {
    ...
    sd.baseMaterial.rollingResistance = 0;
    b3Vec3 vs[8];
    vs[0] = {B3_FIX( 15.0 ), B3_FIX( 1.0 ), B3_FIX( 15.0 )};
    vs[1] = {B3_FIX( -15.0 ), B3_FIX( 1.0 ), B3_FIX( 15.0 )};
    vs[2] = {B3_FIX( -15.0 ), B3_FIX( -1.0 ), B3_FIX( 15.0 )};
    vs[3] = {B3_FIX( 15.0 ), B3_FIX( -1.0 ), B3_FIX( 15.0 )};
    vs[4] = {B3_FIX( 15.0 ), B3_FIX( 1.0 ), B3_FIX( -15.0 )};
    vs[5] = {B3_FIX( -15.0 ), B3_FIX( 1.0 ), B3_FIX( -15.0 )};
    vs[6] = {B3_FIX( -15.0 ), B3_FIX( -1.0 ), B3_FIX( -15.0 )};
    vs[7] = {B3_FIX( 15.0 ), B3_FIX( -1.0 ), B3_FIX( -15.0 )};
    b3HullData* hullData = b3CreateHull(vs, 8, 8);
    b3CreateHullShape(bodyId, &sd, hullData);
    b3DestroyHull(hullData);
  }
